...
df2 = pd.read_csv('datos/vista_insumos.csv')
encabezados = ['id','departamento_nombre','departamento_id','municipio_nombre','municipio_id','producto_id','producto_nombre','valor','fechapublicacion']
df2.columns = encabezados
